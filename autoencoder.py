...
from keras.layers import Input, Conv2D, MaxPooling2D, UpSampling2D, Dense, Flatten, Reshape, regularizers, Dropout
...
def train_model(input_img, decoder, classifier, load=False):
    ...
    autoencoder.compile(optimizer=optimizer, loss=[losses.binary_crossentropy, losses.categorical_crossentropy], loss_weights=[4.0,1.0])
